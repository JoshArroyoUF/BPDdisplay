...
F: Finds nonreduced coBPD if one exists.

O: Change pipe color.

R: Randomize pipe colors.

S: Changes scale of each box.

X: Output Latex code for current BPD (saves it to your clipboard)

Elbow mode: Click to swap between having and not having an elbow in that position.
